#!/bin/sh
# hello-go-deploy-ecs build-push.sh
...
echo "Now we must move our code from the current directory ./hello-go-deploy-ecs to" 
echo "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-ecs"
mkdir -p src/github.com/JeffDeCola/
cp -R ./hello-go-deploy-ecs src/github.com/JeffDeCola/.
echo " "

echo "cd src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01"
cd src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01
echo " "
...
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01/bin/hello-go" .
echo " "

echo "cp the Dockerfile into /dist"
cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01/build-push/Dockerfile" .
echo " "
