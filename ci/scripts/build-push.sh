...
cp -r hello-go-deploy-amazon-ecs/example-01/* dist
echo " "
...
#echo "cd src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01"
#cd src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01
#echo " "
...
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01/bin/hello-go" .
#echo " "

#echo "cp the Dockerfile into /dist"
#cp "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01/build-push/Dockerfile" .
#echo " "
