#!/bin/sh
# hello-go-deploy-ecs unit-test.sh
...
echo "The goal is to set up a go src/github.com/JeffDeCola/hello-go-deploy-ecs directory"
...
echo "cp -R ./hello-go-deploy-ecs $GOPATH/src/github.com/JeffDeCola/."
cp -R "./hello-go-deploy-ecs" "$GOPATH/src/github.com/JeffDeCola/."
echo " "

echo "cd $GOPATH/src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01"
cd "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-ecs/example-01"
echo " "
