#!/bin/sh
# hello-go-deploy-amazon-ecs unit-test.sh
...
echo "The goal is to set up a go src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs directory"
...
echo "cp -R ./hello-go-deploy-amazon-ecs $GOPATH/src/github.com/JeffDeCola/."
cp -R "./hello-go-deploy-amazon-ecs" "$GOPATH/src/github.com/JeffDeCola/."
echo " "

echo "cd $GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01"
cd "$GOPATH/src/github.com/JeffDeCola/hello-go-deploy-amazon-ecs/example-01"
echo " "
