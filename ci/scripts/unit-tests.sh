...
echo "cp -R ./hello-go-deploy-amazon-ecs src/github.com/JeffDeCola/."
...
# echo "mkdir -p test"
# mkdir -p test
# echo "Placeholder to run go tests for hello-go-deploy-amazon-ecs" | tee test/test_coverage.txt
# echo " "
